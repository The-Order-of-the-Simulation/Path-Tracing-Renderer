  ...
  outputs = { nixpkgs, flake-utils, ... }: flake-utils.lib.eachDefaultSystem (system:
    let
      ...
      path-tracing-renderer = (with pkgs; stdenv.mkDerivation {
          ...
          buildPhase = "g++ -march=native -Ofast -s -std=c++11 -Wall -Wextra -Wshadow -I\"./src/include\" \"./src/image.cpp\" \"./src/rng.cpp\" \"./src/scene.cpp\" \"./src/trace.cpp\" \"./src/sky.cpp\" \"./src/path-tracing.cpp\" \"./src/main.cpp\" -o \"./OpenPT\"";
          installPhase = ''
            mkdir -p $out/bin
            mv OpenPT $out/bin
          '';
